...
export default function Topbar({ title }) {
  ...
  return (
    <div className="sp-topbar d-flex align-items-center justify-content-between px-4 py-2">
      <div className="sp-topbar-left d-flex align-items-center gap-2">
        <span className="sp-brand">
          ✕ <strong>Sugar</strong>panel
        </span>
      </div>
      <div className="sp-topbar-right d-flex align-items-center gap-3">
        <div className="lang-dropdown">
          <button className="lang-btn sp-icon-btn">
            {" EN "}
            <svg
        ...
        <button className="sp-icon-btn dots">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="15"
            height="15"
        ...
        <div className="sp-icon-btn-img dots-img">
          <img
